 ...
 <?php settings_errors(); ?>
   ...
   <?php register_wpmpf_woosettings('wpmpf-woosettings-group'); ?>
     <?php 
        ...
        <input type="hidden" name="ecommerce" value="psecommerce"/>
              
                
                  <table class="form-table">
                <br/> 
                                <b>  Select Post Type and taxnomy </b><p>where you want to post to publish<br/>(Note* For PSeCommerce select "product", "product_category"  and "product_tag"</p>
                <tr valign="top">
